...
export default function CoinPage() {
  ...
  const [selectedTimeframe, setSelectedTimeframe] = useState<typeof timeframes[number]["value"]>("1min");
  ...
  // Simulate technical signals based on timeframe
  const getTechnicalSignals = (timeframe: string) => {
    // In a real implementation, these would come from your API
    // Here we're simulating different signals for different timeframes
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="text-2xl font-bold">
                    {((social?.positive || 0) * 100).toFixed(0)}%
                  </div>
                  <Progress
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <Progress
                      ...
                      className="h-2"
                      indicatorClassName={cn(
                          score as any || 0 >= 70 ? "bg-green-500" :
                              score as any || 0 >= 50 ? "bg-yellow-500" :
                                  "bg-red-500"
                      )}
                  />
                </div>
